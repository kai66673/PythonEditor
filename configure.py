...
if __name__=="__main__":
    ...
    parser=ArgumentParser(description="Configure PyPythonEditor module.")
    parser.add_argument(
        '-q', '--qmake',
        dest="qmake",
        type=str,
    ...
    makefile.extra_defines+=['PYTHONEDITOR_LIBRARY','QT_CORE_LIB', 'QT_GUI_LIB', 'QT_WIDGETS_LIB']
    ...
    makefile.extra_libs+=['pythoneditor']
